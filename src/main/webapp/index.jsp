        ...
        <ul class="top_bars">
            <c:choose>
                <c:when test="${!empty customer}">
                    <li style="margin-top: 5px">${customer.name}</li>
                    <li><a href="/logout">退出</a></li>
                </c:when>
                <c:otherwise>
                    <li><a href="login.jsp" class="exit">登录</a></li>
                </c:otherwise>
            </c:choose>
            ...
            <c:forEach var="book" items="${allBooks}">
                <li>
                    <div class="c3_b2_txt">
                        ...
                        <p><a href="/bookInfo?bookId=${book.id}">更多精彩，点击进入</a></p>
                    </div>
                    <div style="float: right;position: relative;top:-170px;right: 50px">
                            <%--动态图片路径--%>
                        <a href="/bookInfo?bookId=${book.id}">
