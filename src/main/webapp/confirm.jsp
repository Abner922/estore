...
<div class="content">
    <div class="contentCenter">
        ...
        <form action="/orderCommit" name="orderForm" method="post">
            ...
            <div class="bigDiv">
                <div class="twoDiv">
                    <b>商家：briup自营</b>
                    <c:forEach items="${confirm}" var="con">
                        <ul class="oneUL">
                            <li>
                                <img src="${con.book.image}" class="pic" width="80px" height="95px">
                                <p>${con.book.name}&nbsp;&nbsp;</p>
                                <p><font>¥${con.book.price}</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×${con.num}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有货</p>
                                <p><img src="images/sureLogo_14.png" alt=""><span>七天无理由退换货</span></p>
                                <c:set var="total" value="${con.num*con.book.price+total}"></c:set>
                            </li>
            ...
            <div class="money">
                <span><font>${confirm.size()}</font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${total}</span>
                <span><img src="images/sureLogo_18.png" alt="">运费：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥0.00</span>

                <span>应付总额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${total}</span>
            </div>
            <div class="submit">
                <span>应付金额：<font>${total}</font><input type="image" src="images/21_03.png"></span>
            </div>
        </form>
    </div>
