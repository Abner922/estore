...
<div class="container5">
    <div class="cn5_top">
        <div class="cn5_top_x center01">
            ...
            <a href="#">${bookInfo.category.name}</a>
        </div>
        <div class="cn5_top_y center01">
            ...
            <div class="cn5topy_2">
                <h1 class="pro_title font15">${bookInfo.name}</h1>
                <div class="pro_price">
                    <div class="pro_price_x">
                        <p> briup价：<b>${bookInfo.price}</b> <a href="#">(降价通知)</a></p>
                    </div>
...
<%--                            <P>${bookInfo.pubDate}</P>--%>
                ...
                <form action="/shopCarAdd" id="addCar" method="post">
                    <div class="pro_buy">
    ...
    <div class="c5_b2">
        ...
        <div class="c5_b2_right">
            ...
            <div class="intro_pics">
                <img class="intro_pic" src="${bookInfo.image}">
            </div>
        </div>
